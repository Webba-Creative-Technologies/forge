...
export function TagInput({
  ...
  const sizeStyles = {
    xs: { fontSize: '0.7rem',    padding: '0.125rem 0.375rem', tagPadding: '0.0625rem 0.25rem', gap: 3 },
    ...
    xl: { fontSize: '0.9375rem', padding: '0.75rem 1.25rem',   tagPadding: '0.5rem 0.75rem',    gap: 10 }
  }
...
export function EmailTagInput(props: EmailTagInputProps) {
  ...
  return (
    <TagInput
      {...props}
      placeholder={props.placeholder || 'Add an email...'}
      validateTag={(tag) => emailRegex.test(tag) ? true : 'Invalid email'}
