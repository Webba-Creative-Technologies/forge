...
import { STATUS_COLORS, AVATAR_COLORS, Z_INDEX } from '../constants'
    ...
    >
      ...
      <div
        style={{
          ...
          transform: pressed && onClick ? 'scale(0.95)' : hovered ? 'scale(1.05)' : 'scale(1)',
...
export function AvatarCard({
  ...
  const { hovered, bind } = useInteractionState({ enabled: !!onClick })
