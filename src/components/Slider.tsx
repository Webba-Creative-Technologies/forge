    ...
    >
      ...
      <div
        ...
        onKeyDown={(e) => {
          ...
          else if (e.key === 'ArrowLeft' || e.key === 'ArrowDown') { onChange(Math.max(min, value - step)); e.preventDefault() }
          else if (e.key === 'Home') { onChange(min); e.preventDefault() }
          else if (e.key === 'End') { onChange(max); e.preventDefault() }
          else if (e.key === 'PageUp') { onChange(Math.min(max, value + step * 10)); e.preventDefault() }
          else if (e.key === 'PageDown') { onChange(Math.max(min, value - step * 10)); e.preventDefault() }
        }}
