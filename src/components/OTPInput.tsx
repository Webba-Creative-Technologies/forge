...
export function OTPInput({
  ...
  const sizeConfig = {
    xs: { width: 28, height: 32, fontSize: '0.875rem', gap: 4 },
    ...
    xl: { width: 60, height: 64, fontSize: '1.75rem',  gap: 12 }
  }
...
// ============================================
// PIN INPUT (Deprecated, prefer OTPInput with masked=true for new code)
// Kept for backward compatibility. Distinct visual style (dot indicators).
// ============================================
