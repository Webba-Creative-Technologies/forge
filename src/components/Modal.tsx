...
export function Modal({
  ...
  const maxWidth = typeof size === 'number' ? size : widthStyles[size]
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: fullScreen ? 'none' : 'var(--shadow-modal)',
...
Modal.Tabs = function ModalTabs({ tabs, value, onChange }: ModalTabsProps) {
  return (
    <div style={{
      display: 'flex',
