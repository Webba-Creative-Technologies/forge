...
export function Skeleton({
  ...
  return (
    <div
      className={className || (animation !== 'none' ? `skeleton-${animation}` : undefined)}
      style={{
        width,
        height: getHeight(),
...
export function SkeletonText({ lines = 3, spacing = 8, className, style }: SkeletonTextProps) {
  return (
    <div className={className} style={{ display: 'flex', flexDirection: 'column', gap: spacing, ...style }}>
